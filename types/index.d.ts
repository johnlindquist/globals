...
declare function replaceInFile(config: ReplaceInFileConfig): Promise<ReplaceResult[]>;
declare function replaceInFile(config: ReplaceInFileConfig, cb: (error: Error, results: ReplaceResult[]) => void): void;
...
export declare type Handlebars = typeof handlebars;
...
export declare type child_process = typeof child_process;
...
export declare type marked = typeof marked;
export interface $ {
